...
<html>
<head>
    <title>Key Management - KeySecure</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-white min-h-screen border-r">
            <nav class="mt-6">
                <div class="px-4 space-y-2">
                    ...
                    <a href="/keys" class="flex items-center px-4 py-3 bg-blue-100 text-blue-700 rounded-lg">
        ...
        <div class="flex-1 p-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Key Management</h1>
            <p class="text-gray-600 mb-8">Manage encryption keys and access controls</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-sm text-gray-600">Pending Rotation</p>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 border-b flex justify-between items-center">
                    <h2 class="text-lg font-semibold text-gray-800">Encryption Keys</h2>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">Master Encryption Key</div>
                                    <div class="text-sm text-gray-500">AES-256</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Symmetric</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">2024-01-15</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">2024-07-15</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">Database Encryption</div>
                                    <div class="text-sm text-gray-500">RSA-2048</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Asymmetric</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">2024-02-01</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">2024-08-01</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                        Active
                                    </span>
